...
const ImageUploader = () => {
  ...
  const [previewUrl, setPreviewUrl] = useState<string | null>(null); // For temporary image preview
    ...
    <div>
      ...
      {(previewUrl || image) && (
        <div className="mt-6">
          ...
          <Image
            src={previewUrl || image || "/default-avatar.png"} // Use previewUrl for temporary preview, otherwise use the uploaded image URL
            alt="Preview"
            width={192}
            height={192}
