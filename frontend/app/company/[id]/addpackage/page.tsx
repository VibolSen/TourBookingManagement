...
interface EditTourFormProps {
  tour: Tour;
  onClose: () => void;
  onSave: (formData: Partial<Tour>) => void;
}

const EditTourForm = ({ tour, onClose, onSave }: EditTourFormProps) => {
...
export default function TravelPackages() {
  ...
  const handleEditClick = async (tourId: string) => {
  ...
  const handleSaveEdit = async (updatedData: Partial<Tour>) => {
    if (id && currentTour) {
  ...
  const filteredTours = (tours as Tour[])
    .filter((tour) => {
