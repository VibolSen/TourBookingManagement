...
export default function ProfilePage() {
  ...
  const [bookingStates, setBookingStates] = useState<Record<string, { loading: boolean; error: string | null }>>({});
  ...
  const handleBooking = async (tourId: string, companyId: string) => {
    ...
    try {
      ...
      setBookingStates((prev) => ({
        ...prev,
        [tourId]: { loading: false, error: error instanceof Error ? error.message : "Error creating booking" },
      }));
