    ...
    <div className="container mx-auto p-9">
        <div className="grid grid-cols-2 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-5 rounded-lg shadow-md">
                ...
                {/* Top Left Image */}
                <div className="relative w-full h-10 md:h-44 bg-yellow-400 flex items-center justify-center rounded-lg">
                  <Image
                ...
                {/* Top Right Image */}
                <div className="relative w-full h-10 md:h-44 bg-blue-100 flex items-center justify-center rounded-lg">
                  <Image
                ...
                {/* Bottom Image */}
                <div className="relative mt-5 w-full h-44 bg-gray-200 flex items-center justify-center rounded-lg">
                  <Image
